...
X(j*bar+3*obj.N+1,j*bar+3*obj.N+1:j*bar+4*obj.N) = er*obj.D1(1,:); % txxtop
X(j*bar+4*obj.N+1,j*bar+4*obj.N+1:j*bar+5*obj.N) = er*obj.D1(1,:); % tyytop
X(j*bar+5*obj.N+1,j*bar+5*obj.N+1:j*bar+6*obj.N) = er*obj.D0(1,:); % txytop
end
