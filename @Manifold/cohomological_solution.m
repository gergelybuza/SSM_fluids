function [W_0i, R_0i,multi_input,varargout] = cohomological_solution(obj, i,  W_0, R_0,multi_input)
                ...
                case 'normalform'
                    ...
                    if ~isempty(J)   
                        ...
                        for j = J
                            w_j = W_M(:,j);
                            % R_0i(j,l) = w_j'*L_il;
                            R_0il(j) = w_j'*L_il; %w_j'*B*v_i = \delta_ij
                        end
                        R_0i(:,l) = R_0il;
