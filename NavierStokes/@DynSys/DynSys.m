...
methods
    %% constructor
    function obj = DynSys(grid_input,pars,U,notation,varargin)
        % varargin is approximate spectrum, if known
        obj = obj@NSE(grid_input,pars); % call NSE constructor
...
%                     tensor_to_multi_index(-obj.nonlinearity())};
    ...
    N = nonlinearity_multiindex_old(obj)
    N = nonlinearity_multiindex3(obj)
end  
end